...
版本：2026/03/30 研究成果報告，約 5 MB。此為研究文件版本，不是結案核定證明。

報告以跨資料集測試比較語音深偽偵測系統，並透過量化方式、可學習群集中心與分類後端的消融實驗，探討聲學表示與偵測表現的關係。研究設定、結果與限制請以報告為準；展示系統提供互動試用，不代表對任意音訊的效果保證。系統建置與資料整理的合作貢獻保留於報告誌謝。

建議閱讀：研究問題（PDF 第 8–10 頁）、跨資料集比較與消融（第 44、47、49–52 頁）、展示系統（第 54–57 頁）、結論與限制（第 58–65 頁）。

PDF SHA-256：`a8488545a84c7cb0528217eea4aca2c530d316651631e02e316a137dbb0a160e`。部署此版本的前端後，頁首也可直接開啟研究報告。
